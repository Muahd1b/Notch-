# Archived Decision: Runnable Shell First
...
> [!TIP]
> This decision is retained for context. The active sequencing docs are the [build plan](../architecture/build-plan.md) and [current-state](../architecture/current-state.md).
